...
module.exports = "<main class=\"main\" role=\"main\">\n  <nav class=\"navbar navbar-toggleable-md navbar-light\">\n    <a class=\"navbar-brand\">\n      <h1 class=\"h1 mb-0\">Synopses</h1>\n    </a>\n    <div class=\"row\">\n      <button aria-label=\"go to home\" type=\"button\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Go to home\" class=\"btn btn-lg nav-link\"\n        (click)=\"goToHome()\">\n        <i title=\"home button\" class=\"fas fa-home\" aria-hidden=\"true\"></i>\n      </button>\n      <button aria-label=\"Create a new book\" type=\"button\" data-toggle=\"modal\" data-target=\"#postModal\" data-toggle=\"tooltip\" data-placement=\"bottom\"\n        title=\"Create a new book\" class=\"btn btn-lg nav-link\" (click)=\"postOpen()\">\n        <i class=\"fas fa-book\" aria-hidden=\"true\"></i>\n      </button>\n    </div>\n  </nav>\n  <div *ngIf=\"newBook\">\n    <app-posts (submission)=\"submission($event)\"></app-posts>\n  </div>\n\n  <router-outlet></router-outlet>\n</main>\n"
...
module.exports = ".main .navbar {\n  background-color: #2b3990; }\n  .main .navbar .navbar-brand {\n    color: #f2f3f2;\n    font-family: Apple Chancery, cursive;\n    font-weight: bolder; }\n  .main .navbar .row button {\n    background-color: #2b3990;\n    color: #f2f3f2; }\n  .main .navbar .row button:focus,\n  .main .navbar .row button:hover {\n    background-color: #f2f3f2;\n    color: #2b3990; }\n  @media (min-width: 576px) {\n  .main .navbar .row {\n    width: 25%;\n    justify-content: space-around; } }\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.postOpen = function () {
        if (this.newBook) {
            this.newBook = false;
        }
        else {
    ...
    AppComponent.prototype.submission = function (closePost) {
...
/* harmony import */ var _book_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./book.service */ "./src/app/book.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                _book_service__WEBPACK_IMPORTED_MODULE_10__["BookService"],
                {
                    provide: _angular_http__WEBPACK_IMPORTED_MODULE_3__["Http"],
                    useFactory: function (backend, defaultOptions) {
                        return new _angular_http__WEBPACK_IMPORTED_MODULE_3__["Http"](backend, defaultOptions);
                    },
...
var BookService = /** @class */ (function () {
    ...
    BookService.prototype.getBook = function (bookPath) {
        return this.http.get("/api/" + bookPath).map(function (res) {
            ...
            res = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["reformatBookData"])(res);
            return res;
        });
    };
    BookService.prototype.getBooks = function () {
        return this.http.get("/api").map(function (res) {
            var convertToJSON = res.json();
            return convertToJSON;
        });
    };
    BookService.prototype.putBook = function (bookPath, data) {
        return this.http.put("/api/" + bookPath, data, {}).map(function (res) {
            res = res.json()[0];
            return res;
        });
    };
    BookService.prototype.postBook = function (data) {
...
module.exports = "h1 {\n  font-family: Didot, Garamond, Futura, \"Trebuchet MS\", Arial, sans-serif; }\n\nh3 {\n  font-family: Didot, Garamond, Baskerville, \"Trebuchet MS\", Arial, sans-serif; }\n\np,\ndiv {\n  font-family: Didot, Garamond, Futura, \"Trebuchet MS\", Arial, sans-serif; }\n\nimg {\n  max-width: 100% !important;\n  height: auto !important;\n  width: auto\\9;\n  /* ie8 */ }\n\n.btn-outline-primary:hover {\n  color: whitesmoke !important;\n  background-color: #5970af !important;\n  border-color: #5970af !important; }\n\n.btn-outline-primary {\n  white-space: normal !important;\n  color: #5970af !important;\n  border-color: #5970af !important;\n  cursor: pointer; }\n\n.btn-primary {\n  color: #f2f3f2 !important;\n  background-color: #5970af !important;\n  cursor: pointer; }\n\n.btn-primary:hover {\n  background-color: #6d80b4 !important; }\n\n/* ---------------- Defaults and small screen first (mobile first) -----------------*/\n\n.book .buttons {\n  background-color: #5970af; }\n\n.book .buttons .nav-link {\n    border: none; }\n\n.book .buttons .fa,\n  .book .buttons .fab,\n  .book .buttons .fas {\n    line-height: 1.25; }\n\n.book .buttons .fa-amazon {\n    background-color: black;\n    color: #ff9900; }\n\n.book .buttons .fa-goodreads {\n    background-color: #f0ede4;\n    color: #614336; }\n\n.book .buttons .fa-wikipedia {\n    background-color: black;\n    color: #f6f6f6; }\n\n.book .buttons .fa-book {\n    background-color: #f6f6f6;\n    color: black; }\n\n.book .author-input {\n  cursor: not-allowed; }\n\n.similar-books .penguin-books .badge {\n  white-space: normal; }\n\n.similar-books .goodreads-books .badge {\n  white-space: normal; }\n\n.similar-books .amazon-books .badge {\n  white-space: normal; }\n\n.similar-books .goodreads-books .flex-container {\n  flex-direction: column; }\n\n.similar-books .goodreads-books .flex-container .card-parent {\n    width: 75%; }\n\n.similar-books .goodreads-books .flex-container .card {\n    background-color: #fafafa; }\n\n@media (min-width: 576px) {\n  .author-book-card {\n    width: 75%; }\n  .book-description,\n  .wiki-text {\n    width: 75%;\n    margin-left: auto;\n    margin-right: auto; }\n  .similar-books .goodreads-books .flex-container {\n    flex-direction: row; }\n    .similar-books .goodreads-books .flex-container .card-parent {\n      width: 50%; } }\n\n@media (min-width: 768px) {\n  small {\n    font-size: 0.75rem; }\n  .book .similar-books .goodreads-books .flex-container .card-parent {\n    width: 25%; }\n    .book .similar-books .goodreads-books .flex-container .card-parent .card-body {\n      display: flex;\n      justify-content: space-around;\n      flex-direction: column; }\n  .book .heading small {\n    font-size: 150%; }\n  .book h5,\n  .book h6 {\n    font-size: 1rem;\n    line-height: 1.3rem; }\n  .book p,\n  .book div,\n  .book .penguin-description {\n    font-size: 0.75rem;\n    line-height: 1.25rem; } }\n\n@media (min-width: 1200px) {\n  .book .card-img-top {\n    width: 50% !important; } }\n"
...
var BookComponent = /** @class */ (function () {
    function BookComponent(route, bookService, sanitizer) {
        this.route = route;
    ...
    BookComponent.prototype.toggle = function (name) {
    ...
    // SHOW THE BUTTON
    BookComponent.prototype.toggleButton = function () {
        this.buttonVisible = true;
    };
    // SHOW BOOK OR AUTHOR IF NOT SHOWING BOOK, ONE OR THE OTHER
    BookComponent.prototype.alterView = function (type) {
    ...
    // CLOSE MODAL IF OPEN
    BookComponent.prototype.closeModal = function () {
        this.turnOff();
    };
    // CLOSE ANY MODAL THAT IS OPEN
    BookComponent.prototype.turnOff = function () {
        var _this = this;
        var keys = Object.keys(this.buttonToggle);
        this.buttonVisible = false;
        keys.forEach(function (key) {
            _this.buttonToggle[key] = false;
        });
    };
    // AMAZON REVIEW IFRAME ONLY LASTS FOR A SINGLE DAY, PUT REQUEST NECESSARY IF UPDATED LATER THEN A DAY AGO
    BookComponent.prototype.checkForAmazonReviews = function () {
        var _this = this;
        var now = new Date();
        var past = new Date(this.book["updated"]);
        ...
        if (Math.floor((now.getTime() - past.getTime()) / (24 * 60 * 60 * 1000)) > 0) {
            this.bookService.putBook(bookPath, data).subscribe(function (data) {
                _this.book["amazonCustomerReviews"] = data["IFrameURL"][0];
            }, function (error) { return console.log(error); }, function () {
                _this.toggle("amazonReviewVisible");
                _this.toggleButton();
    ...
    BookComponent.prototype.getBook = function () {
        var _this = this;
        var bookPath = this.route.snapshot.url[1].path;
        this.bookService.getBook(bookPath).subscribe(function (data) {
            _this.book = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["createBookObject"])(data);
            _this.periods = data["periods"];
            _this.book["penguinData"] = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["reformatPenguinData"])(_this.book.penguinData);
            if (Array.isArray(_this.book["amazonSimilarProducts"])) {
                _this.book["amazonSimilarProducts"] = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["setUpAmazonSimilarBooks"])(_this.book["amazonSimilarProducts"]);
            }
            ...
            return console.log("IF ERROR IN OBTAINING DATA FROM DB FOR INDIVIDUAL BOOK", err);
        }, function () { return (_this.isDataAvailable = true); });
    };
...
module.exports = ".jawn {\n  position: relative;\n  background-color: #f8e71c;\n  width: 3em;\n  height: 3em;\n  margin: 0 auto;\n  border-radius: 50%;\n  top: 35vh; }\n  .jawn:after, .jawn:before {\n    content: \"\";\n    position: absolute;\n    width: 1em;\n    height: 1em;\n    border-radius: 50%; }\n  .jawn:after {\n    left: -3em;\n    top: -1.5em;\n    background-color: #c7c2a6;\n    -webkit-transform-origin: 4.5em 3em;\n            transform-origin: 4.5em 3em;\n    -webkit-animation: axis 1s linear infinite;\n            animation: axis 1s linear infinite; }\n  .jawn:before {\n    left: -7.5em;\n    top: -4.5em;\n    background-color: #009bff;\n    -webkit-transform-origin: 9em 6em;\n            transform-origin: 9em 6em;\n    -webkit-animation: axis 2s linear infinite;\n            animation: axis 2s linear infinite; }\n  @-webkit-keyframes axis {\n  0% {\n    -webkit-transform: rotateZ(0deg) translate3d(0, 0, 0);\n            transform: rotateZ(0deg) translate3d(0, 0, 0); }\n  100% {\n    -webkit-transform: rotateZ(360deg) translate3d(0, 0, 0);\n            transform: rotateZ(360deg) translate3d(0, 0, 0); } }\n  @keyframes axis {\n  0% {\n    -webkit-transform: rotateZ(0deg) translate3d(0, 0, 0);\n            transform: rotateZ(0deg) translate3d(0, 0, 0); }\n  100% {\n    -webkit-transform: rotateZ(360deg) translate3d(0, 0, 0);\n            transform: rotateZ(360deg) translate3d(0, 0, 0); } }\n  /* ---------- Mobile first - smallest screens first and landscape focus then portrait -----------*/\n  .jumbotron {\n  padding-top: var(--jumbotron-padding-y);\n  padding-bottom: var(--jumbotron-padding-y);\n  margin-bottom: 0;\n  background-color: #f2f3f2; }\n  .jumbotron .container .lead {\n  color: #374396; }\n  .accordion .list-group .active {\n  color: #f2f3f2;\n  background-color: #5970af; }\n  .accordion .card-header button {\n  color: #212529; }\n  .accordion .card-header button:hover {\n  border: .5px solid #5970af;\n  color: #009bff; }\n  @media (min-width: 768px) {\n  .jumbotron {\n    padding-top: calc(var(--jumbotron-padding-y) * 2);\n    padding-bottom: calc(var(--jumbotron-padding-y) * 2); } }\n  .jumbotron p:last-child {\n  margin-bottom: 0; }\n  .jumbotron-heading {\n  font-weight: 300; }\n  .jumbotron .container {\n  max-width: 40rem; }\n  #hide {\n  display: none; }\n  .dashboard .jumbotron .display-1 {\n  font-size: 10rem; }\n  .dashboard .input-group .input-lg {\n  height: 10rem;\n  font-size: 4rem; }\n  .dashboard .med-card .title {\n  line-height: 1.4rem; }\n  .dashboard .med-card .card-text {\n  font-size: 0.8rem;\n  line-height: 1.2rem; }\n  .dashboard .card {\n  background-color: #fafafa;\n  border: 1.5px solid #5970af; }\n  .dashboard .card .card-header {\n    background-color: whitesmoke;\n    border-bottom: 1.5px solid #5970af; }\n"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.reroute = function (data) {
        this.router.navigate(["/book/" + data]);
    };
    // SEARCH RESULTS(FILTER RESULTS)
    DashboardComponent.prototype.filterItem = function (value) {
        if (!value) {
            this.filteredItems = [];
        }
        else {
            var fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_2__(this.books, this.fuseOptions);
            var result = fuse.search(value);
            this.fillOutGrid(result);
        }
    };
    // USING CSS GRID
    DashboardComponent.prototype.fillOutGrid = function (result) {
    ...
    DashboardComponent.prototype.formatBooks = function (books) {
    ...
    DashboardComponent.prototype.getBooks = function () {
        ...
        this.bookService.getBooks().subscribe(function (data) {
            _this.books = data;
            _this.books = _this.formatBooks(_this.books);
        }, function (err) { return console.log("FAILED OBTAINING ALL BOOKS FROM API", err); }, function () { return (_this.dataAvailable = true); });
    };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_book_service__WEBPACK_IMPORTED_MODULE_3__["BookService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], DashboardComponent);
...
module.exports = ".jawn {\n  position: relative;\n  background-color: #f8e71c;\n  width: 3em;\n  height: 3em;\n  margin: 0 auto;\n  border-radius: 50%;\n  top: 35vh; }\n  .jawn:after, .jawn:before {\n    content: \"\";\n    position: absolute;\n    width: 1em;\n    height: 1em;\n    border-radius: 50%; }\n  .jawn:after {\n    left: -3em;\n    top: -1.5em;\n    background-color: #c7c2a6;\n    -webkit-transform-origin: 4.5em 3em;\n            transform-origin: 4.5em 3em;\n    -webkit-animation: axis 1s linear infinite;\n            animation: axis 1s linear infinite; }\n  .jawn:before {\n    left: -7.5em;\n    top: -4.5em;\n    background-color: #009bff;\n    -webkit-transform-origin: 9em 6em;\n            transform-origin: 9em 6em;\n    -webkit-animation: axis 2s linear infinite;\n            animation: axis 2s linear infinite; }\n  @-webkit-keyframes axis {\n  0% {\n    -webkit-transform: rotateZ(0deg) translate3d(0, 0, 0);\n            transform: rotateZ(0deg) translate3d(0, 0, 0); }\n  100% {\n    -webkit-transform: rotateZ(360deg) translate3d(0, 0, 0);\n            transform: rotateZ(360deg) translate3d(0, 0, 0); } }\n  @keyframes axis {\n  0% {\n    -webkit-transform: rotateZ(0deg) translate3d(0, 0, 0);\n            transform: rotateZ(0deg) translate3d(0, 0, 0); }\n  100% {\n    -webkit-transform: rotateZ(360deg) translate3d(0, 0, 0);\n            transform: rotateZ(360deg) translate3d(0, 0, 0); } }\n  .cover {\n  background: url(\"https://cdn.spacetelescope.org/archives/images/wallpaper4/heic0611b.jpg\") no-repeat center center fixed;\n  background-size: cover;\n  width: 100vw;\n  height: 100vh;\n  z-index: 1;\n  position: absolute;\n  top: 0;\n  left: 0;\n  overflow-y: none; }\n"
...
module.exports = "<div class=\"modal fade\" id=\"postModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"postModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <h5 class=\"modal-title\" id=\"postModalLabel\">New Book</h5>\n        <button name=\"Close modal\" type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"alert alert-info\" role=\"alert\">\n          Please input as close to the title and author as you can.\n        </div>\n        <form>\n          <div class=\"form-group\">\n            <label for=\"book-name\" class=\"col-form-label\">Book:</label>\n            <input type=\"text\" class=\"title-input form-control\" id=\"book-name\" placeholder=\"Title...\" (keyup)=\"onInput($event)\" (paste)=\"onInput($event)\" />\n          </div>\n          <div class=\"form-group\">\n            <label for=\"author-name\" class=\"col-form-label\">Author:</label>\n            <input type=\"text\" class=\"author-input form-control\" id=\"author-name\" id=\"inputAuthor\" placeholder=\"Author...\" (keyup)=\"onInput($event)\" (paste)=\"onInput($event)\">\n          </div>\n        </form>\n      </div>\n      <div class=\"modal-footer\">\n        <button name=\"close modal\" type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n        <div *ngIf=\"notPressed; else do_this\">\n          <button name=\"create new book\" type=\"submit\" class=\"btn btn-primary post-button\" data-dismiss=\"modal\" (click)=\"newBook($event); buttonPressed()\">Post New Book</button>\n        </div>\n        <ng-template #do_this>\n          <button name=\"data is loading\" class=\"btn btn-default post-button\">\n            API Stuff...\n          </button>\n        </ng-template>\n        <div *ngIf=\"bookPreviouslyCreated\">\n          <div class=\"alert alert-danger alert-dismissable\" role=\"alert\">\n            <button name=\"alert button close\" class=\"close\" (click)=\"close()\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n            Error, either invalid name or book has previously been created.\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<div *ngIf=\"loading\">\n  <app-loading></app-loading>\n</div>\n"
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(http, router, bookService) {
        this.http = http;
        this.router = router;
        this.bookService = bookService;
        // to app component
    ...
    PostsComponent.prototype.onInput = function (event) {
    ...
    PostsComponent.prototype.close = function () {
        this.bookPreviouslyCreated = false;
    };
    // alter state of button press
    PostsComponent.prototype.buttonPressed = function () {
        this.notPressed = false;
    };
    // create new book
    PostsComponent.prototype.newBook = function (event) {
        var _this = this;
        ...
        var data = new ObjectConstructor();
        ...
        this.bookService.postBook(data).subscribe(function (result) {
            // WAIT 5 SECONDS AFTER USER INPUTS PRIOR TO LOADING CODE TO RUN
            if (result["_body"] === "saved") {
                // REDIRECT URL CREATION
                var urlTitle = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["createUrlToRedirect"])(data);
                _this.loading = false;
                // EMIT FUNCTION TO ALTER STATE IN COMPONENT THAT OPENED POST COMPONENT
                _this.submission.emit(false);
                // REROUTE
                _this.router.navigate(["/book/" + urlTitle]);
            }
            else {
                // HTML MESSAGE OF ERROR ON DISPLAY
                _this.notPressed = true;
                _this.loading = false;
                _this.bookPreviouslyCreated = true;
            }
        }, function (error) {
    ...
    ], PostsComponent.prototype, "submission", void 0);
...
/*!**************************!*\
  !*** ./src/app/utils.ts ***!
  \**************************/
/*! exports provided: makeWikiTextPresentable, createBookObject, grabIframe, alterASINtoHREF, reformatBookData, createPaperAnimationData, createUrlToRedirect, reformatPenguinData, setUpAmazonSimilarBooks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeWikiTextPresentable", function() { return makeWikiTextPresentable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createBookObject", function() { return createBookObject; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "grabIframe", function() { return grabIframe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "alterASINtoHREF", function() { return alterASINtoHREF; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reformatBookData", function() { return reformatBookData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createPaperAnimationData", function() { return createPaperAnimationData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createUrlToRedirect", function() { return createUrlToRedirect; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reformatPenguinData", function() { return reformatPenguinData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setUpAmazonSimilarBooks", function() { return setUpAmazonSimilarBooks; });
/* harmony import */ var _book__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./book */ "./src/app/book.ts");
...
function makeWikiTextPresentable(text) {
    var periodCounter = 0;
...
function createBookObject(data) {
    var book = new _book__WEBPACK_IMPORTED_MODULE_0__["Book"]();
...
function grabIframe(str) {
    if (str.split("src=\"").length > 1) {
        var splitWhereSrcIs = str.split("src=\"");
        var idxOfEndOfHref = splitWhereSrcIs[1].indexOf("\"");
        var iFrame = splitWhereSrcIs[1].slice(0, idxOfEndOfHref);
        return iFrame;
    }
    return str;
}
// LINKS WITHIN SIMILAR BOOKS SO THAT IT HAS SOME SORT OF USE
function alterASINtoHREF(arr) {
    return arr.map(function (idxValue) {
        idxValue.ASIN[0] = "http://www.goodreads.com/book/isbn/" + idxValue.ASIN[0];
        return idxValue;
    });
}
function reformatBookData(data) {
    ...
    // ONLY NEED IFRAME
    data["goodreads_reviews_widget"] = grabIframe(data["goodreads_reviews_widget"]);
    if (data["amazon_similar_products"] !== null) {
        data["amazon_similar_products"] = alterASINtoHREF(data["amazon_similar_products"]);
    }
    return data;
}
// PAPER ANIMATION DATA
function createPaperAnimationData() {
    var paper = "assets/falling-paper.png";
    var papers = [];
    for (var i = 0; i < 20; i++) {
        papers[i] = {};
        papers[i]["str"] = paper;
...
function createUrlToRedirect(data) {
    // LOWERCASE THE TITLE AND AUTHOR
    data.title = data.title.toLowerCase();
    data.author = data.author.toLowerCase();
    // CREATE THE URL TITLE
    var urlTitle = data.title.split(" ").join("_") + "_" + data.author.split(" ").join("_");
...
function reformatPenguinData(data) {
    return data.map(function (book, i) {
...
function setUpAmazonSimilarBooks(data) {
    var newData = [];
...
Object(_angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_2__["platformBrowserDynamic"])()
    ...
    .catch(function (err) { return console.log("FUNDAMENTAL ERROR IN PROGRAM, IN MAIN.TS", err); });
...
module.exports = __webpack_require__(/*! /Users/JJM/coding/synopses/src/main.ts */"./src/main.ts");
