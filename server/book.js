...
bookSchema.pre('save', function (next) {
    ...
    this.amazon_editorial_review, this.isbn, this.wikipedia, this.goodreads_description, this.author_name, this.penguin_data = checkAllStrings(this.amazon_reviews, this.amazon_editorial_review, this.isbn, this.wikipedia, this.goodreads_description, this.author_name, this.penguin_data);
